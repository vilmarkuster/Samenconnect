...
export async function POST(req: NextRequest) {
  try {
    ...
    const payload = {
      ...
      care_needs: typeof body.care_needs === "string" ? body.care_needs.trim() || null : null,
      preferred_location: typeof body.preferred_location === "string" ? body.preferred_location.trim() || null : null,
...
export async function PUT(req: NextRequest) {
  try {
    ...
    if (typeof body.care_needs === "string") payload.care_needs = body.care_needs.trim() || null;
    if (typeof body.preferred_location === "string") payload.preferred_location = body.preferred_location.trim() || null;
