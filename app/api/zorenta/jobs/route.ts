...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const { title, description, city, region, country, care_type, budget_min, budget_max, hourly_rate, schedule, availability } = parsed.data;
