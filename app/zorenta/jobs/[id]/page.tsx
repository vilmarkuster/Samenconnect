  ...
  async function handleBatchContactSelectedAi() {
    ...
    try {
      ...
      if (navConversationId) {
        router.push(`/zorenta/berichten?conversation=${encodeURIComponent(navConversationId)}`);
      }
      if (successCount > 0) {
                ...
                {isPoster ? (
                  ...
                  <div className="space-y-2">
                    {myApplication?.conversationId ? (
                      <Button
                        ...
                        onClick={() => {
                          ...
                          if (cid)
                            router.push(`/zorenta/berichten?conversation=${encodeURIComponent(cid)}`);
                        }}
                      >
                        Open gesprek
                      </Button>
                    ...
                    <Button
                      ...
                      onClick={() => router.push("/zorenta/applications")}
                    >
                      Bekijk matches
                    </Button>
                  </div>
                ...
                <div className="flex flex-wrap gap-2">
                  {myApplication?.conversationId ? (
                    ...
                    <Button
                      type="button"
                      className="bg-[#40ADA8] text-white hover:bg-[#369e9a]"
                      onClick={() => router.push("/zorenta/berichten")}
                    >
                      Ga naar berichten
                    </Button>
                  )}
                  <Button type="button" variant="outline" onClick={() => router.push("/zorenta/jobs")}>
                    Terug naar opdrachten
                  </Button>
                </div>
              </div>
