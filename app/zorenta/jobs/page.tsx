          ...
          <>
            <div className="flex flex-wrap items-center gap-2">
              <Input
                ...
                className="h-9 w-36 rounded-lg border-slate-200 bg-white sm:w-40"
              />
              <select
              ...
              <Button variant="outline" size="sm" onClick={() => setFilterCity(city)} className="gap-1.5">
