                ...
                <tbody>
                  {reviews.map((r) => (
                    <tr key={r.id} className="border-b border-slate-100 hover:bg-slate-50/50">
                      ...
                      <td className="px-4 py-3">
                        <Link href={`/zorenta/admin/users/${r.reviewer_id}`} className="text-slate-700 hover:underline">
                          {r.reviewer?.display_name ?? r.reviewer_id.slice(0, 8)}
                        </Link>
                      </td>
                      <td className="px-4 py-3">
                        <Link href={`/zorenta/admin/users/${r.reviewee_id}`} className="text-slate-700 hover:underline">
