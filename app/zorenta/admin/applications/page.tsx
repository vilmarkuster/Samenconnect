                  ...
                  {applications.map((a) => (
                    <tr key={a.id} className="border-b border-slate-100 hover:bg-slate-50/50">
                      <td className="px-4 py-3">
                        <Link href={`/zorenta/admin/jobs/${a.job_id}`} className="font-medium text-slate-900 hover:underline">
                          {a.job?.title ?? a.job_id.slice(0, 8)}
                        </Link>
                      </td>
                      <td className="px-4 py-3">
                        <Link href={`/zorenta/admin/users/${a.applicant_id}`} className="text-slate-700 hover:underline">
